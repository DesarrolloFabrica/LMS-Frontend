      ...
      <div className="relative z-10 mx-auto w-full max-w-[min(1280px,calc(100%-2rem))] px-4 pb-12 pt-8 sm:px-6 sm:pb-16 sm:pt-12">
        <RevealOnScroll viewportAmount={0.3}>
          <div className="group relative overflow-hidden rounded-[2.5rem] border border-white/60 bg-white/40 p-8 shadow-[0_8px_40px_rgb(0,0,0,0.04)] backdrop-blur-3xl transition-all duration-500 hover:bg-white/60">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,360px)] lg:items-center">
              <div className="flex min-w-0 flex-col justify-between gap-6">
                <div>
                  <div className="mb-4 flex flex-wrap items-center gap-3 text-xs font-semibold tracking-widest text-slate-400 uppercase">
                  ...
                  <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-500">
                    Workspace de creacion inteligente. Complete los parametros requeridos para establecer el nuevo ecosistema educativo.
                  </p>
                </div>

                <div className="flex w-fit shrink-0 items-center gap-2.5 rounded-full border border-amber-200/50 bg-amber-50/80 px-4 py-2 shadow-sm backdrop-blur-md">
              ...
              <div className="pointer-events-none relative mx-auto flex w-full max-w-[340px] items-center justify-center lg:mx-0 lg:justify-self-end">
                <div className="absolute inset-6 rounded-full bg-blue-300/20 blur-3xl" aria-hidden />
                <div className="relative h-[220px] w-full overflow-hidden rounded-[2rem] border border-white/50 bg-white/35 p-3 shadow-[0_12px_40px_rgb(59,130,246,0.10)] backdrop-blur-2xl sm:h-[260px]">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-blue-100/40" aria-hidden />
                  <div className="relative h-full w-full rounded-[1.5rem] bg-gradient-to-br from-slate-50/80 to-blue-50/60">
                    <DotLottieReact
                      src={HERO_LOTTIE_SRC}
                      loop
                      autoplay
          ...
          <div className="space-y-6 lg:col-span-8">
            <RevealOnScroll as="section" viewportAmount={0.18} className="group relative overflow-hidden rounded-[2rem] border border-white/60 bg-white/40 p-6 shadow-[0_4px_20px_rgb(0,0,0,0.02)] backdrop-blur-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:p-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-bold uppercase tracking-widest text-slate-700">Informacion base</h2>
              </div>
              <div className="mt-6">
            ...
            <RevealOnScroll as="section" viewportAmount={0.18} className="group relative overflow-hidden rounded-[2rem] border border-white/60 bg-white/40 p-6 shadow-[0_4px_20px_rgb(0,0,0,0.02)] backdrop-blur-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:p-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-bold uppercase tracking-widest text-slate-700">Resumen academico</h2>
              </div>
              <div className="mt-6">
                <div className="mb-2 flex items-center justify-between">
                  <label className="text-xs font-semibold uppercase tracking-wider text-slate-500">Resumen</label>
                  <span className="text-[10px] font-medium text-slate-400">MIN. 20 CARACTERES</span>
                </div>
            ...
            <RevealOnScroll as="section" viewportAmount={0.18} className="relative overflow-hidden rounded-[2rem] border border-blue-200/50 bg-gradient-to-br from-blue-50/90 to-indigo-50/90 p-6 shadow-inner sm:p-8">
              ...
              <div className="relative z-10 flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
                <div>
                  <h2 className="text-sm font-bold uppercase tracking-widest text-blue-900">Revision previa al envio</h2>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="overflow-hidden rounded-[2rem] border border-white/60 bg-white/40 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-2xl">
                ...
                <p className="mt-4 text-xs font-medium text-slate-500">
                  <span className="font-bold text-slate-700">{completedCount} de 3</span> parametros completados
                </p>
              </div>

              {/* Checklist Card */}
              <div className="overflow-hidden rounded-[2rem] border border-white/60 bg-white/40 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-2xl">
                <h3 className="text-xs font-bold uppercase tracking-widest text-slate-700">Guia de Validacion</h3>
                <p className="mt-3 text-sm leading-relaxed text-slate-500">
                  Asegurate de cumplir con los criterios para una revision acelerada por parte del sistema.
                </p>
